...
MODEL_DIR="${PROJECT_ROOT}/experiments/nli/${ADAPTATION_METHOD}_${BASE_MODEL_SHORT}_${SOURCE_LANG}_sa-${SOURCE_ADAPTATION}_ss-${NUM_SOURCE_SHOTS}_epochs-${FULL_FT_EPOCHS}_${SPARSE_FT_EPOCHS}"
