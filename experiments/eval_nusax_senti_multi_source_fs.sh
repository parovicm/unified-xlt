...
MODEL_DIR="${PROJECT_ROOT}/experiments/sa_multi_source_fs/${ADAPTATION_METHOD}_${BASE_MODEL_SHORT}_id_la-${LANGUAGE_ADAPTATION}_ss-all_ts-100_upsampling-10_epochs-${FULL_FT_EPOCHS}_${SPARSE_FT_EPOCHS}"
